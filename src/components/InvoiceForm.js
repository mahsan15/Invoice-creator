...
class InvoiceForm extends React.Component {
  ...
  render() {
    return (
      <>
        <a
          href="https://github.com/mahsan15/Invoice-creator.git"
          target="_blank"
          ...
          <Row>
            <Col md={8} lg={9}>
              <Card className="p-4 p-xl-5 my-3 my-xl-4">
                ...
                <Row className="mb-5">
                  <Col>
                    <Form.Label id="bill" className="fw-bold">
                      Bill to:
                    </Form.Label>
                    <Form.Control
                ...
                <hr className="my-4" />
                <Form.Label id="note" className="fw-bold">
                  Note:
                </Form.Label>
                <Form.Control
                  placeholder="Pleasure doing business with you!"
                  name="notes"
            ...
            <Col md={4} lg={3}>
              <div className="sticky-top pt-md-3 pt-xl-4">
                ...
                <Form.Group className="mb-3">
                  <Form.Label id="curr" className="fw-bold">
                    Currency:
                  </Form.Label>
                  <Form.Select
                    onChange={(event) =>
                ...
                <Form.Group className="my-3">
                  <Form.Label id="tax" className="fw-bold">
                    Tax rate:
                  </Form.Label>
                ...
                <Form.Group className="my-3">
                  <Form.Label id="disc" className="fw-bold">
                    Discount rate:
                  </Form.Label>
                  <InputGroup className="my-1 flex-nowrap">
                    <Form.Control
